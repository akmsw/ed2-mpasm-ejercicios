;   Ejercicio 4.2:
;
;   Escribir un programa que lea de dos pulsadores, conectados a RA4 y RB0,
;   el estado lógico y lo muestre en dos de los LEDs, RB2 y RB3.
...
;	mostrado por RB2.
;
;	Si un pulsador está pulsado, su estado será '1' y el output será
;	su respectivo LED encendido. De lo contrario, el estado será '0'
...
;-------------------INICIO DEL PROGRAMA-----------------------------------------
    ...
    LOOP    BTFSC   PORTA,4	    ; Chequeo el estado de RA4.
	    BSF	    PORTB,3	    ; Si está en '1', prendo RB3.
	    BTFSC   PORTB,0	    ; Chequeo el estado de RB0.
	    BSF	    PORTB,2	    ; Si está en '1', prendo RB2.
	    
	    BTFSS   PORTA,4	    ; Chequeo nuevamente el estado de RA4.
	    BCF	    PORTB,3	    ; Si ahora está apagado, apago RB3.
	    BTFSS   PORTB,0	    ; Chequeo nuevamente el estado de RB0.
	    BCF	    PORTB,2	    ; Si ahora está apagado, apago RB2.
