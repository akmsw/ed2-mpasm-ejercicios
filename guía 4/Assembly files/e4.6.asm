;   Ejercicio 4.6:
;
;   Considerando el mismo hardware del ejercicio 4.4, escribir un programa que
;   ilumine los LEDs conectados a PORTD según las siguientes especificaciones:
;
;   * Inicialmente (al salir del reset), aparecen parpadeando los LEDs.
;   * Si se aprieta el pulsador conectado al pin RA4, se produce un
;     desplazamiento de derecha a izquierda.
;   * Si se vuelve a apretar el pulsador RA4, cambia el sentido del
;     desplazamiento.
;   * El desplazamiento debe comenzar al soltar el pulsador.
;   * En cualquier momento, al apretar el pulsador conectado al pin RB0, se
;     vuelve al parpadeo inicial.
...
;-------------------COMENTARIOS-------------------------------------------------
;
;	Este ejercicio, al igual que el 4.5, está hecho de manera muy tosca
;	por el hecho de que en la unidad 4 no se abarcan las interrupciones.
;	Para poder apreciar correctamente el comportamiento del PIC en la
;	simulación en Proteus, hay que hacer lo mismo que en el ejercicio
;	4.5. Ver la sección COMENTARIOS del ejercicio 4.5 para entender mejor.
