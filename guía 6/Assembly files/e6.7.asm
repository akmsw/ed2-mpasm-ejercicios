...
;-------------------CONFIGURACION DE REGISTROS----------------------------------
 ...
 CONFIG_    MOVLW   0x04	    ; Vamos a trabajar con un teclado 4x4.
	    ...
	    MOVWF   D_QUA
	    MOVLW   0x36	    ; El buffer tendrá 6 registros.
	    MOVWF   BUFF_LIM
...
;   código.
;   Como comentario, hay un bug que no he podido identificar en el código, y
;   que sólo se puede apreciar en las simulaciones en Proteus: cuando el
;   programa arranca, la primer pulsación en el teclado no se toma, recién a la
;   segunda pulsada se comienza a escribir en el buffer.
;
